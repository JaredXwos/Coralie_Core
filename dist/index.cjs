...
var Signer = class _Signer {
  constructor(secretKey) {
    ...
    this.pubkeyHex = (0, import_nostr_tools.getPublicKey)(secretKey);
  }
  /**
   ...
   */
  verify(event) {
    return (0, import_nostr_tools.verifyEvent)(event);
  }
  /**
   ...
   */
  ecdh(theirPubkeyHex) {
    return import_nostr_tools.nip44.v2.utils.getConversationKey(this.secretKey, theirPubkeyHex);
  }
  /**
   * NIP-44 v2 encrypt: encrypt plaintext to a recipient.
   */
  encryptNip44(theirPubkeyHex, plaintext) {
    return import_nostr_tools.nip44.v2.encrypt(plaintext, this.ecdh(theirPubkeyHex));
  }
  /**
   * NIP-44 v2 decrypt: decrypt ciphertext from a sender.
   */
  decryptNip44(theirPubkeyHex, ciphertext) {
    return import_nostr_tools.nip44.v2.decrypt(ciphertext, this.ecdh(theirPubkeyHex));
  }
  /**
